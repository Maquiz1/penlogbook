...
// $type = $override->getNews('user', 'status', 1, 'type', $profile['type'])[0];
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Mentorship <span>| This Year</span></h5>
                                    <a href="info.php?id=1">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ps-3">
                                                <h6><?= $override->getCount('mentorships', 'status', 1) ?></h6>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Mentors <span>| This Year</span></h5>
                                    <a href="info.php?id=3&type=3">
                                        <div class="d-flex align-items-center">
                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="ps-3">
                                                <h6><?= $override->getCount1('user', 'status', 1, 'type', 3) ?></h6>
                        ...
                        <div class="col-xxl-4 col-xl-12">
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Total Mentees <span>| This Year</span></h5>
                                    <a href="info.php?id=3&type=4">
                                        <div class="d-flex align-items-center">
                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                                <i class="bi bi-people"></i>
                                            </div>
                                            <div class="ps-3">
                                                <h6><?= $override->getCount1('user', 'status', 1, 'type', 4) ?></h6>
