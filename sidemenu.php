    ...
    <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="info.php?id=4">
                        <i class="bi bi-circle"></i><span>Mentorships</span>
                    </a>
                </li>
                <!-- <li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#tables-nav1" data-bs-toggle="collapse" href="#">
                <i class="bi bi-layout-text-window-reverse"></i><span>Summary</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="tables-nav1" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="mentorships.php">
                        <i class="bi bi-circle"></i><span>Mentorships</span>
                    </a>
                </li>
                <li>
                    <a href="info.php?id=3&type=3">
                        <i class="bi bi-circle"></i><span>Mentors</span>
                    </a>
                </li>
                <li>
                    <a href="info.php?id=3&type=4">
                        <i class="bi bi-circle"></i><span>Mentee</span>
                    </a>
                </li>
                <li>
                    <a href="reports.php">
                ...
                <li>
                    <a href="reports.php">
                        <i class="bi bi-circle"></i><span>Competences</span>
                    </a>
                </li>
            </ul>
        </li>
