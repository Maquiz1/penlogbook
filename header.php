...
if ($user->isLoggedIn()) {
    ...
    $profile = $override->getNews('user', 'status', 1, 'id', $user->data()->id)[0];
...
<!-- 
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-block dropdown-toggle ps-2"><?= $profile['firstname'] . ' ' . $profile['lastname'] ?></span>
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="profile.php?id=1&user_id=<?= $user->data()->id ?>">
